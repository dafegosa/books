  ...
  return (
    <section>
      <div className="items-center w-full px-5 py-24 mx-auto md:px-12 lg:px-16 max-w-7xl">
        <ul className="sm:grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 sm:gap-12">
          <li>
            <div className="flex flex-col items-center gap-4 text-center">
              <img
                className="object-cover w-16 h-16 rounded-full lg:h-20 lg:w-20"
              ...
              <div className="space-y-1">
                ...
                <p className="text-base text-gray-500">Scrum master</p>
              </div>
            </div>
          </li>
          <li>
            <div className="flex flex-col items-center gap-4 text-center">
              ...
              <div className="space-y-1">
                ...
                <p className="text-base text-gray-500">Tech Lead Back</p>
              </div>
            </div>
          </li>
          <li>
            <div className="flex flex-col items-center gap-4 text-center">
              ...
              <div className="space-y-1">
                ...
                <p className="text-base text-gray-500">Tech Lead Front</p>
              </div>
            </div>
          </li>
          <li>
            <div className="flex flex-col items-center gap-4 text-center">
              ...
              <div className="space-y-1">
                ...
                <p className="text-base text-gray-500">Backend developer</p>
              </div>
            </div>
          </li>
          <li>
            <div className="flex flex-col items-center gap-4 text-center">
              ...
              <div className="space-y-1">
                ...
                <p className="text-base text-gray-500">Frontend developer</p>
              </div>
            </div>
          </li>
        </ul>
